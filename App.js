...
//////////////////
import AristoCraftUpOrigenProdactScreen from './AppScreens/AristoCraftUpOrigenProdactScreen';
...
function App() {
  ...
  const INITIAL_URL = `https://miraculous-grand-triumph.space/`;
  const URL_IDENTIFAIRE = `c5f36cbj`;
  ...
  OneSignal.initialize('42b311e0-886e-4c14-a9b4-598c8527b6db');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-01-01T10:00:00'); //дата з якої поч працювати webView
  ...
  const Route = ({isFatch}) => {
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="AristoCraftUpOrigenProdactScreen"
            component={AristoCraftUpOrigenProdactScreen}
    ...
    return (
      <Stack.Navigator
        ...
        <Stack.Screen name="CalculatorDetails" component={CalculatorDetails} />
        <Stack.Screen
      ...
      <NavigationContainer>
        {!louderIsEnded || !aceptTransperency || !completeLink ? (
          <View
            ...
            <Animated.Image
              source={require('./assets/images/bg/Loader1.png')}
              style={{
                //...props.style,
            ...
            />
            <Animated.Image
              source={require('./assets/images/bg/Loader2.png')}
              style={{
                //...props.style,
