...
const AristoCraftUpOrigenProdactScreen = ({navigation, route}) => {
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../assets/images/bg/arrow77.png')}
          />
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../assets/images/bg/redo77.png')}
          />
        </TouchableOpacity>
      </View>
    </SafeAreaView>
...
export default AristoCraftUpOrigenProdactScreen;
